...
var SwipeableViews = function (_React$Component) {
  ...
  function SwipeableViews(props) {
    ...
    _this.handleScroll = function (event) {
      ...
      var maxNumberOfSlides = _react2.default.Children.count(_this.props.children);

      if (event.target.scrollTop || event.target.scrollTop == 0 && (maxNumberOfSlides == _this.state.indexCurrent + 1 || maxNumberOfSlides - 2 == _this.state.indexCurrent)) {
        return;
      }
